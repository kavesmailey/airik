  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[76px] max-w-[1440px] items-center justify-between gap-6 px-5 sm:px-8 md:h-[84px] md:px-10 lg:px-12">
          ...
          {siteConfig.navigation.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className="group relative shrink-0 whitespace-nowrap py-3 text-[11px] text-black/50 transition-colors duration-300 hover:text-black lg:text-[12px] xl:text-[13px]"
              >
        ...
        <div className="hidden shrink-0 md:block">
          <Link
            ...
            className="group inline-flex items-center gap-2 rounded-full bg-black px-4 py-2.5 text-[11px] font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-black/85 lg:px-5 lg:text-[12px]"
          >
        ...
        <button
          ...
          className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-black/10 transition-colors duration-300 hover:bg-black/5 md:hidden"
        >
      ...
      <div
        ...
        className={`overflow-hidden border-t border-black/10 transition-[max-height,opacity] duration-300 ease-out md:hidden ${
