...
return (
<div
className={mx-auto px-4 transition-all duration-500 sm:px-8 lg:px-12 ${ scrolled ? "py-3" : "py-4 sm:py-5" }}
>
<div
className={mx-auto flex max-w-[1600px] items-center justify-between rounded-full border px-3 py-2.5 transition-all duration-500 sm:px-5 ${ scrolled ? "border-[#022F12]/10 bg-white/90 shadow-[0_8px_30px_rgba(2,20,8,0.06)] backdrop-blur-xl" : "border-transparent bg-transparent" }}
>
<Link
href=”/”
